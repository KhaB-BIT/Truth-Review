...
function ListProducts() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cors-anywhere.herokuapp.com/https://shop-home.sendo.vn/api/v1/product/filter?limit=30&page=${page}&platform=1&seller_admin_id=717078&sortType=vasup_desc`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://cors-anywhere.herokuapp.com/https://api.sendo.vn/onsite-services/shop/collection/external?merchant_external_id=717078"
      )
      .then((res) => {
